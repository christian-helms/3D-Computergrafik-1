 ...
 * ```
 */
export declare class Texture3D extends AbstractObject<WebGLTexture> implements Bindable {
    /**
     ...
     */
    load(url: string, slices: GLsizei, crossOrigin?: boolean): Promise<void>;
    /**
     ...
     */
    data(data: TexImage3DData, bind?: boolean, unbind?: boolean): void;
    /**
